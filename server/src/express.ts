...
//TODO use a boilerplate like https://github.com/edwinhern/express-typescript-2024 instead
...
import fs from "./common/firebase/firestore";

// initializeApp(); //done in init => firebaseApp
...
const appListener=onRequest(app);
